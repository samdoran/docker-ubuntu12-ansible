...
[![Docker Cloud Automated build](https://img.shields.io/docker/cloud/automated/samdoran/ubuntu12-ansible.svg)](https://hub.docker.com/r/samdoran/ubuntu12-ansible/) ![Docker Pulls](https://img.shields.io/docker/pulls/samdoran/ubuntu12-ansible.svg)
...
platforms:
  - name: role-test
    image: "samdoran/${MOLECULE_DISTRIBUTION:-ubuntu12}-ansible:latest"
