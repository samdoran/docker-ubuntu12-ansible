...
[![Container Repository on Quay](https://quay.io/repository/samdoran/ubuntu12-ansible/status "Container Repository on Quay")](https://quay.io/repository/samdoran/ubuntu12-ansible)
...
To build your own version of this container, run:
    ...
    podman build -t ubuntu12-ansible -f Containerfile .
